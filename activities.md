...
Special Session devoted to 'Discrete and Algorithmic Mathematics' within the Congreso Bienal de la Real Sociedad Matemática Española (RSME) 2024. The session is organized by the members of the networks with the following speakers: Maria Bras (URV), Simon Briend (UPF), María Ángeles Hernández Cifre (U. Murcia), Kolja Knauer (UB), Julio J. Moyano-Fernández (UJI), Marc Noy (UPC), Ignacio Ojeda (U. Extremadura).
